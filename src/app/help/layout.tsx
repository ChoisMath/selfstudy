  ...
  return (
    <main className="min-h-dvh bg-gray-50 text-gray-950">
      <header className="border-b border-blue-800 bg-blue-700 text-white">
        <div className="mx-auto flex w-full max-w-5xl items-center gap-3 px-2 py-4 md:px-3 lg:px-4">
      ...
      <div className="mx-auto w-full max-w-5xl px-2 py-4 sm:py-8 md:px-3 lg:px-4 lg:py-12">{children}</div>
    </main>
  );
}
